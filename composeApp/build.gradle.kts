...
kotlin {
    ...
    sourceSets {
        ...
        commonMain.dependencies {
            ...
            implementation(project(":feature:note-list-impl"))
            implementation(project(":feature:note-list-api"))
            ...
            implementation(project(":feature:contacts-impl"))
...
android {
    namespace = "com.develop.micronotes"
    compileSdk = libs.versions.android.compileSdk.get().toInt()

    defaultConfig {
        applicationId = "com.develop.micronotes"
